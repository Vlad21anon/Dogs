package com.ukadovlad21.dogapplication.Share;
 ...
 * @version 1.0
 */
public class CacheJava {
    private final Context context;

    public static final String TAG = CacheJava.class.getSimpleName();
    ...
    public CacheJava(Context context) {
